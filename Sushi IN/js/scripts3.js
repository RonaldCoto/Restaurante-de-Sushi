(function(){
     function $(selector){
        ...
        function Carrito(){
            this.catalogo = [{id:'C01',nombre:'BANANA TEMPURA',precio:2.95,imagen:'postre1.jpg',descripcion:'4 cortes de banana tempurizados con sorbete y topping de su elección.'},
                            {id:'C02',nombre:'MOCHI DE VAINILLA',precio:2.95,imagen:'postre2.jpg',descripcion:'Tradicional postre japones a base de masa de arroz, relleno de helado de elección.'},
                            {id:'C03',nombre:'BROWNIE TEMPURA',precio:3.95,imagen:'postre3.jpg',descripcion:'Trozos de brownie tempurizado, sorbete de vainilla y el topping de tu elección.'},];
